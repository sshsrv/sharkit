...
class VerifactTool(Tool):
    metadata = ToolMetadata(
        name="verifact",
        description="Verifact — AI-powered fact-checking for URLs and claims",
        category="humint",
        author="sharkit",
        version="0.1.0",
        safety="moderate",
        ...
        install=ToolInstallSpec(
            git_url=None,
            pip_args=["git+https://github.com/AravindB98/verifact"],
        ),
    )
    ...
    def __init__(self) -> None:
        self._options: dict[str, OptionDefinition] = {
            "query": OptionDefinition(
                name="query",
                description="URL or claim to analyze",
                required=True,
            ),
        }
